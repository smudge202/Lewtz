    ...
    public partial class FormLewtz
    {
        public void LoadTables()
        {
            ...
            MinorMagicTable.AddEntry(MinorPotionsTable, 44);
                MinorPotionsTable.AddEntry(new MagicItem("Potion", "Potion Name", 2, 0), 1, false, true, true);
            MinorMagicTable.AddEntry(MinorRingsTable, 46);
                MinorRingsTable.AddEntry(new MagicItem("Ring", "Ring Name", 2, 0), 1, false, true, true);
            MinorMagicTable.AddEntry(MinorScrollsTable, 81);
                MinorScrollsTable.AddEntry(new MagicItem("Scroll", "Scroll Name", 2, 0), 1, false, true, true);
            MinorMagicTable.AddEntry(MinorWandsTable, 91);
                MinorWandsTable.AddEntry(new MagicItem("Wand", "Wand Name", 2, 0), 1, false, true, true);
            ...
            MajorMagicTable.AddEntry(MajorScrollsTable, 45);
