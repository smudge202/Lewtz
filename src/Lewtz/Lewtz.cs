...
namespace Lewtz
{
	// NOTHING in a forms class is testable, so we want to keep the logic
	// to a minimum and trust that it passes everything to/fro it's presenter.
	// This is referred to as the MVP pattern.
	public partial class FormLewtz : Form
	{
		private readonly Presenters.IMainPresenter _presenter;
		...
		internal FormLewtz(Presenters.IMainPresenter presenter)
			: this()
		{
			if (presenter == null)
		...
		// TODO: All commented code below needs extracting to the relevant layer
		// TODO: Rename these effing controls to something that makes sense!! :D
		// TODO: Consistently name the controls. Is it btnDoStuff or DoStuffButton ?
		// ^ I prefer the latter; the former is known as "hungarian notation"
		...
		{
			_presenter.TerminateApplication();
		}
		//private void exitToolStripMenuItem_Click_1(object sender, EventArgs e)
		//{
		//	Application.Exit();
